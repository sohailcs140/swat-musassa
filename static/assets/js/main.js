...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var searchData = {pages:[
        {url:"/app/visa-renew/", icon:'menu-icon tf-icons mdi mdi-autorenew', name:"Visa Renew"},
        {url:"/core/visa/", icon:'menu-icon tf-icons mdi mdi-card-account-details', name:"Visas"},
        {url:"/app/reports/visas/", icon:'menu-icon tf-icons mdi mdi-finance', name:"Reports"},
        {url:"/app/employer/create-list/", icon:'menu-icon tf-icons mdi mdi-account-group', name:"Employers"},
        {url:"/app/employee/create-list/", icon:'menu-icon tf-icons mdi mdi-crowd', name:"Employees"},
        {url:"/accounts/create-list/", icon:'menu-icon tf-icons mdi mdi-account-supervisor', name:"Users"},
        {url:"/core/recycle-bin/?tab=employees", icon:'menu-icon tf-icons mdi mdi-recycle', name:"Recycle Bin"},
        {url:"/", icon:'menu-icon tf-icons mdi mdi-recycle', name:"Dasboard"},
        {url:"/accounts/password-change/", icon:'menu-icon tf-icons mdi mdi-key-change', name:"Change Password"},
